 ...
 * - [CustomersCreateFragment]: to create or edit a(n) Customer,
 * - [CustomersDetailFragment]: to display the details of a(n) Customer,
 ...
 * what to do.
 */
class CustomersActivity : AppCompatActivity(), InterfacedFragment.InterfacedFragmentListener<Customer> {
    ...
    override fun onFragmentStateChange(evt: Int, entity: Customer?) {
        when (evt) {
    ...
    private fun onItemClicked(entity: Customer?) {
    ...
    @Suppress("UNUSED_PARAMETER")
    private fun onEditItem(entity: Customer?) {
    ...
    internal class DeleteConfirmationDialogFragment : DialogFragment() {
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            val fragmentActivity = requireActivity() as AppCompatActivity
            val builder = MaterialAlertDialogBuilder(fragmentActivity, R.style.AlertDialogStyle)
            val viewModel = ViewModelProvider(fragmentActivity)[CustomerViewModel::class.java]

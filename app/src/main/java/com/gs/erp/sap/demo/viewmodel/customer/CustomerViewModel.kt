...
package com.gs.erp.sap.demo.viewmodel.customer
 ...
 */
class CustomerViewModel(application: Application): EntityViewModel<Customer>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.customers, Customer.city) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        this.repository = EntityViewModel<Customer>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.customers, Customer.city, navigationPropertyName, entityData).repository
    }
}

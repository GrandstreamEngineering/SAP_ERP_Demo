...
package com.gs.erp.sap.demo.viewmodel.stock
 ...
 */
class StockViewModel(application: Application): EntityViewModel<Stock>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.stock, Stock.lotSize) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        this.repository = EntityViewModel<Stock>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.stock, Stock.lotSize, navigationPropertyName, entityData).repository
    }
}

...
package com.gs.erp.sap.demo.viewmodel.salesorderheader
 ...
 */
class SalesOrderHeaderViewModel(application: Application): EntityViewModel<SalesOrderHeader>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.salesOrderHeaders, SalesOrderHeader.createdAt) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        this.repository = EntityViewModel<SalesOrderHeader>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.salesOrderHeaders, SalesOrderHeader.createdAt, navigationPropertyName, entityData).repository
    }
}

 ...
 * - [SalesOrderHeadersCreateFragment]: to create or edit a(n) SalesOrderHeader,
 * - [SalesOrderHeadersDetailFragment]: to display the details of a(n) SalesOrderHeader,
 * - [SalesOrderHeadersListFragment]: to list SalesOrderHeaders.
 *
 ...
 * what to do.
 */
class SalesOrderHeadersActivity : AppCompatActivity(), InterfacedFragment.InterfacedFragmentListener<SalesOrderHeader> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.masterFrame, SalesOrderHeadersListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit()
        } else {
    ...
    override fun onFragmentStateChange(evt: Int, entity: SalesOrderHeader?) {
        when (evt) {
    ...
    private fun onItemClicked(entity: SalesOrderHeader?) {
        if (!isMasterDetailView) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.masterFrame, SalesOrderHeadersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if (detail == null) {
                if (entity != null)
                    supportFragmentManager.beginTransaction()
                        .replace(R.id.detailFrame, SalesOrderHeadersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                        .commit()
            } else {
                if( entity == null) {
    ...
    @Suppress("UNUSED_PARAMETER")
    private fun onEditItem(entity: SalesOrderHeader?) {
        val updateFragment = SalesOrderHeadersCreateFragment()
        val arguments = Bundle()
    ...
    internal class ConfirmationDialogFragment : DialogFragment() {
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button) { _, _ ->
                (fragmentActivity as SalesOrderHeadersActivity).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null)
            }
    ...
    internal class DeleteConfirmationDialogFragment : DialogFragment() {
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            val fragmentActivity = requireActivity() as AppCompatActivity
            val builder = MaterialAlertDialogBuilder(fragmentActivity, R.style.AlertDialogStyle)
            val viewModel = ViewModelProvider(fragmentActivity)[SalesOrderHeaderViewModel::class.java]

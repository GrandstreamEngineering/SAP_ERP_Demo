...
package com.gs.erp.sap.demo.viewmodel.producttext
 ...
 */
class ProductTextViewModel(application: Application): EntityViewModel<ProductText>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.productTexts, ProductText.language) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        this.repository = EntityViewModel<ProductText>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.productTexts, ProductText.language, navigationPropertyName, entityData).repository
    }
}

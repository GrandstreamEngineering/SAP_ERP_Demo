...
package com.gs.erp.sap.demo.viewmodel.salesorderitem
 ...
 */
class SalesOrderItemViewModel(application: Application): EntityViewModel<SalesOrderItem>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.salesOrderItems, SalesOrderItem.mac) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        this.repository = EntityViewModel<SalesOrderItem>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.salesOrderItems, SalesOrderItem.mac, navigationPropertyName, entityData).repository
    }
}

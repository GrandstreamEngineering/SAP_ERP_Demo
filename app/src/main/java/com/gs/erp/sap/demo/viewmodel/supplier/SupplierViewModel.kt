...
package com.gs.erp.sap.demo.viewmodel.supplier
 ...
 */
class SupplierViewModel(application: Application): EntityViewModel<Supplier>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.suppliers, Supplier.city) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        this.repository = EntityViewModel<Supplier>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.suppliers, Supplier.city, navigationPropertyName, entityData).repository
    }
}

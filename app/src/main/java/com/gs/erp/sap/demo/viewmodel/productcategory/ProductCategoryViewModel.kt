...
package com.gs.erp.sap.demo.viewmodel.productcategory
 ...
 */
class ProductCategoryViewModel(application: Application): EntityViewModel<ProductCategory>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.productCategories, ProductCategory.categoryName) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        this.repository = EntityViewModel<ProductCategory>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.productCategories, ProductCategory.categoryName, navigationPropertyName, entityData).repository
    }
}

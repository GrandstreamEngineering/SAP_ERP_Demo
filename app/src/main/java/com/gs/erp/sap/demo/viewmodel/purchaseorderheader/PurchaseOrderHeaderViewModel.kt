...
package com.gs.erp.sap.demo.viewmodel.purchaseorderheader
 ...
 */
class PurchaseOrderHeaderViewModel(application: Application): EntityViewModel<PurchaseOrderHeader>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.purchaseOrderHeaders, PurchaseOrderHeader.currencyCode) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        this.repository = EntityViewModel<PurchaseOrderHeader>(application, Com_sap_mbtepmdemoServiceMetadata.EntitySets.purchaseOrderHeaders, PurchaseOrderHeader.currencyCode, navigationPropertyName, entityData).repository
    }
}
